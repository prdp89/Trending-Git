package com.example.internetdetector.core
...
class InternetDetector(private val context: Context, private val serverUrl: String = "https://www.google.com/",
    ...
    private class NetworkCallback @ExperimentalCoroutinesApi constructor(private val liveData: ProducerScope<Boolean>, private val context: Context,
